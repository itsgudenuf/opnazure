...
#fetch https://raw.githubusercontent.com/itsgudenuf/opnazure/dev_active_active/scripts/$1
#fetch https://raw.githubusercontent.com/itsgudenuf/opnazure/master/scripts/$1
